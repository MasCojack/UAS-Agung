...
<head>
    ...
    <meta name="description" content="Aplikasi Data Pegawai">
...
<body>
    <div class="container-fluid">
        <div class="d-flex flex-column flex-md-row align-items-center p-3 px-md-4 mb-3 bg-white border-bottom shadow-sm">
            <h5 class="my-0 mr-md-auto font-weight-normal text-info"><i class="fas fa-user title-icon"></i> Manajemen Data</h5>
            <?php
            ...
            if (empty($_GET["page"])) { ?>
                ...
                <a class="btn btn-outline-info" href="logout.php" role="button"><i class="fas fa-arrow-left"></i> Logout</a>
            <?php
            }
            // jika halaman = tambah atau ubah, maka tampilkan menu Kembali
            else { ?>
                <a class="btn btn-outline-info" href="dashboard.php" role="button"><i class="fas fa-arrow-left"></i> Kembali</a>
            <?php
            }
            ?>
